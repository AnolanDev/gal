...
class ColombianStatesSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if (!$colombia) {
            $this->command->error('No se encontró Colombia en la base de datos. Ejecuta primero CountriesSeeder.');
            return;
        }
        ...
        $departments = [
            ...
            ['name' => 'Bogotá D.C.', 'code' => '11'], // Distrito Capital
        ];
